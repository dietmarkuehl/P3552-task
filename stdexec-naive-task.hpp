    ...
    struct task {
...
#endif
        {
            ...
            void* operator new(std::size_t size) {
                ...
                std::cout << "promise_type new(" << size << ")->" << pointer << "\n";
                return pointer;
            }
            template <typename Alloc, typename... Args>
            void* operator new(std::size_t size, std::allocator_arg_t, Alloc& alloc, Args&&...) {
                void* pointer(std::malloc(size));
                std::cout << "promise_type allocator new(" << size << ")->" << pointer << " alloc=" << &alloc << "\n";
                return pointer;
            }
            void operator delete(void* pointer, std::size_t size) noexcept {
                std::cout << "promise_type delete(" << pointer << ", " << size << ")\n";
